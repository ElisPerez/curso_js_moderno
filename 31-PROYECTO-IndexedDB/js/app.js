...
function nuevaCita(e) {
  ...
  if (editando) {
    ...
    transaction.oncomplete = function () {
      console.log('Cita guardada en DB indexedDB');
...
function createDB() {
  ...
  createDB.onerror = function () {
    console.log('Hubo un error al crear la base de datos indexedDB');
  };

  // Si todo sale bien
  createDB.onsuccess = function () {
    console.log('Base de datos "citas" de indexedDB creada satisfactoriamente');

    DB = createDB.result;
    // console.log(DB);

    // Mostrar citas al cargar (pero ya indexedDB ya está listo).
    ui.imprimirCitas();
  };
